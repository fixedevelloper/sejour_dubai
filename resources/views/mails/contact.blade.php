                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            <a href="#"><img style="height: 40px" src="{!! asset('logo.png') !!}" alt="logo"></a>
                            <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">{!! $subject !!}</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 30px 30px 20px">
                            <h5 style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">Hi {!! $name !!}<br>!</h5>
                            <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">{!! $data !!}. </p>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding:25px 20px 0;">
                            <p style="font-size: 13px;">Copyright © 2020 Guen's. All rights reserved.</p>
                            <ul style="margin: 10px -4px 0;padding: 0;">
                                ...
                                <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="#"><img style="width: 30px" src="{!! asset('assets/images/brand/sup.jpg') !!}" alt="brand"></a></li>
